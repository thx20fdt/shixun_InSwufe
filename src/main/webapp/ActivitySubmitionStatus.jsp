    ...
    <div class="ui grid">
      ...
      <div class="thirteen wide column">
        ...
        <div class="ui attached segment">
          <div class="ui middle aligned four column grid">
            ...
            <div class="right aligned column">
              <div class="ui label">
                截止时间：
                <div class="detail">${endtime}</div> <!--这里你可以根据需要替换为实际的时间值-->
              </div>
            </div>
          </div>
        </div>
        <div class="ui attached segment">
          ...
          <div class="ui grid">
            <div class="column" style="padding-top: 5px; padding-bottom: 10px;">
              <h4>学生提交情况</h4>
            </div>
          </div>
          <table class="ui celled table">
            ...
            <c:forEach var="submit" items="${submitList}">
              <tr>
                ...
                <td><a href="IsRead?AID=${submit.AID}&SID=${submit.SID}">查看</a></td>
              </tr>
            </c:forEach>
            </tbody>
          </table>
